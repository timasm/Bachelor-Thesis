...
class Trainer_perceputal:
    def __init__(self, model, device, perceputal_loss, train_path, dataset_path, trainings_round=0, batch_size=32, num_workers=8, learning_rate=0.0001, l1_lambda=0.00001):
        self.model = model
        self.device = device
    ...
    def train(self, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            for batch_original, batch_downsampled in zip(dataloader_original, dataloader_downsampled):
                ...
                combined_loss += self.l1_lambda * l1_reg
